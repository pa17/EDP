...
class Ui_SimpleButton(object):
    def setupUi(self, SimpleButton):
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(70, 450, 161, 171))
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(70, 90, 721, 84))
        font = QtGui.QFont()
        font.setPointSize(8)
    ...
    def retranslateUi(self, SimpleButton):
        ...
        self.BREEZETitle.setText(_translate("SimpleButton", "Breeze Test Results", None))
