...
class Ui_CustomWidget(object):
    def setupUi(self, CustomWidget):
        ...
        self.WSButton = QtGui.QRadioButton(CustomWidget)
        self.WSButton.setObjectName(_fromUtf8("WSButton"))
        self.gridLayout.addWidget(self.WSButton, 1, 0, 1, 1)
        self.VolFlowButton = QtGui.QRadioButton(CustomWidget)
        self.VolFlowButton.setObjectName(_fromUtf8("VolFlowButton"))
        self.gridLayout.addWidget(self.VolFlowButton, 2, 0, 1, 1)
        ...
        self.VolButton = QtGui.QRadioButton(CustomWidget)
        self.VolButton.setObjectName(_fromUtf8("VolButton"))
        self.gridLayout.addWidget(self.VolButton, 6, 0, 1, 1)
    ...
    def retranslateUi(self, CustomWidget):
        ...
        self.WSButton.setText(_translate("CustomWidget", "Breath Speed", None))
        self.VolFlowButton.setText(_translate("CustomWidget", "Volumetric Flow Rate", None))
        self.checkBox.setText(_translate("CustomWidget", "Mouse Enabled", None))
        self.VolButton.setText(_translate("CustomWidget", "Volume", None))
